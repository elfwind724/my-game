...
export const BUILDING_DEFS: Record<string, BuildingDef> = {
  ...
  watchtower: {
    ...
    nameCN: '瞭望塔',
    category: 'defense',
    description: 'Extends detection range and buffs nearby turrets',
    descriptionCN: '扩大探测范围并增强附近炮台',
    tier: 2,
    maxTier: 3,
    health: 200,
    healthPerTier: 100,
    cost: { wood: 12, metal: 8, scrap: 5 },
    size: 1,
    color: 0x556b2f,
  ...
  barricade: {
    ...
    nameCN: '路障',
    category: 'defense',
    description: 'Slows enemies significantly when they pass through',
    descriptionCN: '大幅减速通过的敌人',
    tier: 1,
    maxTier: 3,
    health: 60,
    healthPerTier: 30,
  ...
  research_lab: {
    ...
    nameCN: '研究所',
    category: 'utility',
    description: 'Unlocks advanced crafting and boosts production',
    descriptionCN: '解锁高级制造并增强产出',
    tier: 2,
    maxTier: 3,
    health: 150,
    healthPerTier: 75,
    cost: { metal: 20, scrap: 15, energyCore: 1 },
    size: 1,
    color: 0x4169e1,
  ...
  signal_jammer: {
    ...
    nameCN: '信号干扰器',
    category: 'special',
    description: 'Reduces enemy spawn rate nearby',
    descriptionCN: '减少附近敌人生成概率',
    tier: 2,
    maxTier: 3,
    health: 120,
    healthPerTier: 60,
    cost: { metal: 15, scrap: 10, energyCore: 1 },
    size: 1,
    color: 0x708090,
    secondaryColor: 0xb0c4de,
    special: 'jam_spawn',
    powerUse: 3,
  },
  sniper_nest: {
    ...
    nameCN: '狙击巢',
    category: 'turret',
    description: 'Long-range high-damage single-target turret',
    descriptionCN: '远距离高伤害单体炮台',
    tier: 2,
    maxTier: 3,
    health: 180,
    healthPerTier: 90,
    cost: { metal: 20, ammo: 15, scrap: 10 },
    size: 1,
    color: 0x2f4f4f,
  ...
  flame_turret: {
    ...
    nameCN: '火焰炮台',
    category: 'turret',
    description: 'Short-range area damage with burn effect',
    descriptionCN: '短距离范围灼烧炮台',
    tier: 2,
    maxTier: 3,
    health: 200,
    healthPerTier: 100,
    cost: { metal: 18, scrap: 12, ammo: 8 },
    size: 1,
    color: 0x8b0000,
